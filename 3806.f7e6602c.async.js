(self.webpackChunk_ant_design_pro_editor=self.webpackChunk_ant_design_pro_editor||[]).push([[3806],{56487:function(Q,f,n){"use strict";n.d(f,{Z:function(){return d}});var S=n(26068),i=n.n(S),m=n(67825),k=n.n(m),D=n(57820),x=n(50518),K=n(38720),B=n(53649),y=n.n(B),U=n(53131),z,R,b,W=(0,U.kc)(function(j,v){var g=j.token,C=j.css,M=j.cx,N=j.prefixCls,X=v.size,q=v.className,G="".concat(N,"-").concat(g.editorPrefix,"-icon"),_=typeof X=="number"?C(z||(z=y()([`
          width: `,`px !important;
          height: `,`px !important;
        `])),X,X):"",$=C(R||(R=y()([`
    display: flex;
  ...
  `])),t.colorPrimary,t.colorTextLightSolid,c,t.colorTextLightSolid)}}),Cn=n(38720),tn=n(86323),Pn,Hn=function(){var t=P(),r=t.addScript,c=(0,B.S)();return(0,o.jsx)(Z.D,{className:(0,y.cx)((0,y.iv)(Pn||(Pn=x()([`
        padding: 8px;
        border-radius: 8px;
        background: `,`;
        .ant-form-item {
  ...
  `])),s.colorTextSecondary,s.colorFillQuaternary);return{defaultButton:d(B||(B=i()([`
    ...
    `])),(0,m.DZ)(.4)(s.colorBgElevated))}}},1427:function(){}}]);
