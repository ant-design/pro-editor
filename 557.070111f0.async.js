"use strict";(self.webpackChunk_ant_design_pro_editor=self.webpackChunk_ant_design_pro_editor||[]).push([[557],{75262:function(e,n,t){t.r(n);var a=[{language:"bash",text:"Bash",code:`#!/bin/bash
...
- comment`},{language:"html",text:"Html",code:`<html lang="en">
    ...
    </html>`}];n.default=a},65161:function(e,n){n.Z=`import { Highlight } from '@ant-design/pro-editor';
...
`},18408:function(e,n){n.Z=`import { Highlight } from '@ant-design/pro-editor';
...
`},17628:function(e,n){n.Z=`const configs = [
  {
    language: 'bash',
    text: 'Bash',
    code: '#!/bin/bash\\n\\n###### CONFIG\\nACCEPTED_HOSTS="/root/.hag_accepted.conf"\\nBE_VERBOSE=false\\n\\nif [ "$UID" -ne 0 ]\\nthen\\n echo "Superuser rights required"\\n exit 2\\nfi\\n\\ngenApacheConf(){\\n echo -e "# Host \${HOME_DIR}$1/$2 :"\\n}\\n\\necho \\'"quoted"\\' | tr -d \\\\\\\\/" > text.txt\\n\\n',
...
`},12810:function(e,n){n.Z=`import { Highlight } from '@ant-design/pro-editor';
...
`},14079:function(e,n){n.Z=`import { Highlight } from '@ant-design/pro-editor';
